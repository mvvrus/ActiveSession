namespace MVVrus.AspNetCore.ActiveSession
{
    ...
    /// <param name="RunnerNumber">The integer key to be used to access the runner object  later via <see cref="IActiveSession.GetRunner{TResult}(int, String?)"></see> method</param>
